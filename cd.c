 ...
 * @datash: it represents the important data (environ)
 * Return: no return
 */
...
/**
 * cd_to - it changes to the directory given by the user
 * @datash: the important data (directories)
 * Return: no return
 */
 ...
 * @datash: the important data (environ)
 * Return: no return
 */
